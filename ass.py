...
st.markdown(
    """
Estimandの各要素に関連する規定を探し、試験結果を正しく解釈するための成立要件と、それが満たされているかを確認するための情報を整理します。有害事象発生時の対応についても、規定どおり実施されているかを確認するための情報を整理します。

さらに、CTTIのCTQ要因と本試験の特性を照合し、CTQ候補とリスク案を提示します。
"""
)
