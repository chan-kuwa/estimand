...
さらに「CTQを深堀りする」ボタンを押すことで、CTTIの原則を参考に、CTQ要因を出力します。
本ツールでは、CTQ要因を個別データや手順ではなく、
エスティマンド解釈を成立させるために必要な運用状態として定義しています。
また同時に出力される、観測データはCTQの状態が実際に維持されているかを確認するための情報として整理されます。
""")
